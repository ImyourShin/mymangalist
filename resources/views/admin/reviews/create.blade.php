...
@section('content')
    ...
    <form action="{{ route('admin.reviews.create') }}" method="post">
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
                <input type="number" class="form-control" name="user_id" required placeholder="User ID"
                    value="{{ old('user_id') }}">
                @error('user_id')
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
                <input type="number" class="form-control" name="manga_id" required placeholder="Manga ID"
                    value="{{ old('manga_id') }}">
                @error('manga_id')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
                <textarea class="form-control" name="comment" rows="4" required placeholder="Write your review">{{ old('comment') }}</textarea>
                @error('comment')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
