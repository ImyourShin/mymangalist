...
@push('styles')
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;700&family=Poppins:wght@400;500;700&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        /* ===== Page ===== */
        body {
            background: radial-gradient(1000px 600px at 50% -200px, #0a0a0a 0%, var(--dark-bg) 70%);
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 12px 30px rgba(255, 107, 71, .35);
        }
        ...
        .stat-card:hover {
            ...
            box-shadow: 0 0 0 1px rgba(255, 107, 71, .25), 0 12px 30px rgba(0, 0, 0, .5);
        }
        ...
        .icon img {
            ...
            height: 60%;
            object-fit: contain;
            filter: drop-shadow(0 0 6px rgba(255, 76, 0, .4));
        }
        ...
        .manga-badge {
            ...
            padding: 6px 14px;
            border-radius: 999px;
            box-shadow: 0 4px 12px rgba(255, 107, 71, .4);
            z-index: 3;
        ...
        .btn-detail:hover {
            box-shadow: 0 8px 20px rgba(255, 107, 71, .4);
            transform: translateY(-2px);
            color: white;
        }
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="card-info">
                                                <div class="info-row"><i
                                                        class="fas fa-pen"></i><span><strong>Author:</strong>
                                                        {{ $fav->manga->author ?? 'Unknown Author' }}</span></div>
                                                <div class="info-row"><i
                                                        class="fas fa-info-circle"></i><span><strong>Status:</strong>
                                                        {{ $fav->manga->status ?? 'N/A' }}</span></div>
                                            </div>
