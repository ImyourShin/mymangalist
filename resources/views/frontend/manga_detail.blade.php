    ...
    <div class="glass-card mt-4">
        <div class="row g-4">
            ...
            <div class="col-md-4 text-center">
                @if ($manga->cover_img)
                    <img src="{{ asset('storage/' . $manga->cover_img) }}" class="cover-img" style=" object-fit: cover;">
                @else
                ...
                @else
                    <a href="{{ route('login') }}" onclick="alert('Please login before adding to favorites.')"
            ...
            <div class="col-md-8">
                ...
                <p>
                    ...
                    Twenty-year-old Sung Jin-Woo is one such Hunter, but he is known as the "World's Weakest," owing to his
                    pathetic power compared to even a measly E-Rank.
                    Still, he hunts monsters tirelessly in low-rank Gates to pay for his mother's medical bills.
                </p><br>
                <p>
                    However, this miserable lifestyle changes when Jin-Woo—believing himself to be the only one left to die
                    in a mission gone
                    terribly wrong—awakens in a hospital three days later to find a mysterious screen floating in front of
                    him. This "Quest Log" demands that Jin-Woo
                    completes an unrealistic and intense training program, or face an appropriate penalty. Initially
                    reluctant to comply because of the quest's rigor,
        ...
        <div class="review-card">
            ...
            @auth
                <div class="review-actions">
                    @can('update', $review)
                        <a href="{{ route('frontend.reviews.edit', $review->review_id) }}" class="btn btn-sm btn-edit">Edit</a>
                    @endcan
